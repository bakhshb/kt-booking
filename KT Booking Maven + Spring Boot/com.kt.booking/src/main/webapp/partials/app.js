...
myApp.config (function($routeProvider){
	...
	.when('/post',{templateUrl:'partials/post/post.html', controller:'postCtrl'})
	.when('/search',{templateUrl:'partials/search/search.html', controller:'searchCtrl'})
	.when('/display',{templateUrl:'partials/display/display.html', controller:'displayCtrl'})
